...
> DONT THINK I NEED THIS SINCE IT IS ALL CASES STATEWIDE. This filters out hospitals with fewer than 300 deliveries over the total data period. 
...
ahrq_pcsec_rate_tx_summary <- ahrq_pcsec %>% 
  ...
  filter(TOTAL >= 300) %>% # I DON'T THINK I NEED THIS FOR THIS SUMMARY
  mutate(
   SUMMARY = "TX",
