...
These views are all of vaginal deliveries only.

> I need to make a data set of all deliveries to get a complete look.

### Episiotomy rates doctor in Laredo

Vaginal deliveries vs episiotomies for all years combined, with rate. Doctors with fewer than 10 vaginal deliveries excluded. Some doctors have delivered at both hospitals.
