...
### VBAC by hospital by year as long data

This data is filtered for hospitals that have 30+ deliveries of patients with previous ceseareans in a given year.

Instead of filtering, I _could_ create a column that indicates if they've had 30+ in a year.
...
vbac_hosp_yr_table <- vbac_hosp_yr %>%
