...
- hosp_sums_2019: (Selected characteristics by hospital for 2019). Grouped by YR, THCIC_ID and PROVIDER_NAME. Includes ECRATE (Episiotomy or Cesarean rate), ERATE (Episiotomy rate), CRATE (Cesarean rate), MCRATE (Medicaid rate) and DELSPERWK (Deliveries per doctor per week).
