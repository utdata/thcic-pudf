...
- csec_hosp_rate_yr: Table format. Row is per hospital. Columns are years. Observations are the Cesarean rate.

```{r}

# if (test_flag == F) csec_rate_hosp %>% 
#   arrange(PROVIDER_NAME) %>% 
#   write_csv("exports/csec_rate_hosp.csv")
# 
if (test_flag == F) csec_hosp_rate_yr %>%
  arrange(PROVIDER_NAME) %>%
  write_csv("exports/csec_hosp_rate_yr.csv")

# if (test_flag == F) epi_rate_hosp %>% 
#   arrange(PROVIDER_NAME) %>% 
#   write_csv("exports/epi_rate_hosp.csv")
# 
# if (test_flag == F) epi_rate_hosp_yr %>% 
#   arrange(PROVIDER_NAME) %>% 
#   write_csv("exports/epi_rate_hosp_yr.csv")
# 
# if (test_flag == F) epicsec_rate_hosp %>% 
#   arrange(PROVIDER_NAME) %>% 
#   write_csv("exports/epicsec_rate_hosp.csv")
# 
