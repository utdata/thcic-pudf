...
In this view I remove doctors with fewer than 10 deliveries in a given year to give a more accurate look at the staff doctors that do the bulk of deliveries.
...
Delivery rate per doctor by year. Unknown doctors are suppressed. Infrequent deliveries (<10/year) are filtered out.
...
Excludes hosptials with fewer than 100 deliveries in our time span.
...
This looks to see if a mother had either a cesarean or an episiotomy. All the same things apply: All doctors, all complications, but hospitals with fewer than 100 deliveries in our time period are excluded.
