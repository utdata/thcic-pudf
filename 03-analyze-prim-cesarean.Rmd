...
A way to handle this might be this:
- Create a cesarean column based on MS-DRG codes. This is easy.
- Create a column that is hysterotomy. This is more complicated because we have to look through each SURG_PROC column for any value in the prcse2p_list. Perhaps a long `case_when` could handle this. This is where our mutate challenge might come in.
